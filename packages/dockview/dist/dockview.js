...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('C:/Users/Enth/Desktop/projects/moss-tabs/node_modules/style-inject/dist/style-inject.es.js'), require('react'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'C:/Users/Enth/Desktop/projects/moss-tabs/node_modules/style-inject/dist/style-inject.es.js', 'react', 'react-dom'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.dockview = {}, global.styleInject, global.React, global.ReactDOM));
})(this, (function (exports, styleInject, React, ReactDOM) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  const GridviewReact = React.forwardRef((props, ref) => {
      ...
      React.useEffect(() => {
          ...
          const api = createGridview(domRef.current, Object.assign(Object.assign({}, extractCoreOptions$2(props)), frameworkOptions));
          const { clientWidth, clientHeight } = domRef.current;
          api.layout(clientWidth, clientHeight);
          if (props.onReady) {
              props.onReady({ api });
  ...
  const PaneviewReact = React.forwardRef((props, ref) => {
      ...
      React.useEffect(() => {
          ...
          const api = createPaneview(domRef.current, Object.assign(Object.assign({}, extractCoreOptions$1(props)), frameworkOptions));
          const { clientWidth, clientHeight } = domRef.current;
          api.layout(clientWidth, clientHeight);
          if (props.onReady) {
              props.onReady({ api });
